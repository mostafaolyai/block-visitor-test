...
export class ValidatorPipe implements PipeTransform {
    ...
    private checkProps(
        ...
        // URL
        if (check.url && !this.validationString.isUrl(value)) return this.error.push(this.message(ValidatorMessage.invalid, title));

        // LINKEDIN
        if (check.linkedin && !this.validationString.isLinkedin(value))
            return this.error.push(this.message(ValidatorMessage.invalid, title));

        // SMARTSHEET LINK
        if (check.smartsheetLink && !this.validationString.isSmartsheet(value))
            return this.error.push(this.message(ValidatorMessage.invalid, title));
