import { ValidatorInterface } from './interface/validator.interface';

export const Validator =
    (validator: ValidatorInterface | { [key: string]: ValidatorInterface }, isArray?: boolean): PropertyDecorator =>
